...
public class PlayerRequestDto {
    ...
    @Schema(description = "Имя игрока", example = "Виталий", requiredMode = Schema.RequiredMode.REQUIRED)
    private String name;

    @NotBlank(message = "Surname is required")
    @Size(min = 2, max = 50, message = "Surname must be between 2 and 50 characters")
    @Schema(description = "Фамилия игрока", example = "Пинчук", requiredMode = Schema.RequiredMode.REQUIRED)
    private String surname;

    @NotNull(message = "Number is required")
    @Min(value = 1, message = "Number must be at least 1")
    @Max(value = 99, message = "Number must be at most 99")
    @Schema(description = "Игровой номер", example = "97", minimum = "1", maximum = "99")
    ...
    @Schema(description = "Возраст игрока", example = "25", minimum = "16", maximum = "50")
    private Integer age;

    @NotNull(message = "Team ID is required")
    @Positive(message = "Team ID must be positive")
    @Schema(description = "Идентификатор команды игрока", example = "1",
    ...
    @Schema(description = "Количество шайб забитых за карьеру", example = "15", minimum = "0", maximum = "100")
    ...
    @Schema(description = "Количество ассистов за карьеру", example = "25", minimum = "0", maximum = "100")
